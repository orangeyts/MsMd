...
public class SearchServiceImpl implements SearchService {
    ...
    public ResultModel query(String queryString, String price, Integer page) throws Exception {
         ...
         * ====消耗时间为=========18ms
         */
        Directory directory = FSDirectory.open(Paths.get("d:\\luceneIndexDir2"));
        //5. 创建输入流对象
    ...
    public void createFullIndex() throws Exception  {
        List<TbWeekReport> all = weekReportService.getAll();
        List<Document> docList = new ArrayList<>();
        for(TbWeekReport sku : all){
            //2. 创建文档对象
            ...
            document.add(new TextField("userName", sku.getUserName(), Field.Store.YES));
            document.add(new TextField("summary", sku.getSummary(), Field.Store.YES));
        ...
        Directory  dir = FSDirectory.open(Paths.get("d:\\luceneIndexDir2"));
